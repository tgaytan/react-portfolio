    ...
    return (
        <>
            <div className="page-body">
                ...
                <p className="text-background text">I am a recent graduate of a Full Stack Web Developer course with The University of Texas at Austin. My portfolio showcases recent projects demonstrating my skills.  
